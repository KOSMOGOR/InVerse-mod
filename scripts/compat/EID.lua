...
local MomentuumCardDesc = {
    en = {
        ...
        [Card.CARD_TEMPERANCE] = "Gives {{Collectible135}} and gulped {{Trinket149}}#If you remove the Bag, it breaks giving you 2-20 melting halves of hearts#The panic button disappears in this case too",
    ...
    ru = {
        ...
        [Card.CARD_TEMPERANCE] = "Даёт {{Collectible135}} и проглоченную {{Trinket149}}#Если убрать капельницу, то она ломается и даёт 2-20 исчезающих половинок сердец#Кнопка паники в таком случае исчезает тоже",
